...
public class GetAllArticlesTest extends AbstractContainerBaseTest {
    ...
    @Test
    public void testGetAllArticlesReturnsSuccessful() throws Exception {
    ...
    @Test
    public void testGetAllArticlesReturnsBody() throws Exception {
        URI apiEndpoint = this.buildUri();
        ResponseEntity<ArticlePage> response = this.sendGetRequest(apiEndpoint);
    ...
    @Test
    public void testGetAllArticlesReturnsContent() throws Exception {
        URI apiEndpoint = this.buildUri();
        ResponseEntity<ArticlePage> response = this.sendGetRequest(apiEndpoint);
    ...
    @Test
    public void testGetAllArticlesPage0ReturnsValidAmountOfArticles() throws Exception {
    ...
    @Test
    public void testGetAllArticlesPage0ReturnsValidArticles() throws Exception {
        URI apiEndpoint = this.buildUri(0, this.PAGE_SIZE);
        ResponseEntity<ArticlePage> response = this.sendGetRequest(apiEndpoint);
        ArticlePage page = response.getBody();
        List<ArticleGetDTO> articles = page.getContent();
    ...
    @Test
    public void testGetAllArticlesPage1ReturnsValidAmountOfArticles() throws Exception {
    ...
    @Test
    public void testGetAllArticlesPage1ReturnsValidArticles() throws Exception {
        URI apiEndpoint = this.buildUri(1, this.PAGE_SIZE);
        ResponseEntity<ArticlePage> response = this.sendGetRequest(apiEndpoint);
        ArticlePage page = response.getBody();
        List<ArticleGetDTO> articles = page.getContent();
