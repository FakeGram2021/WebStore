const AlertError = ({ text, handleClose }) => (
  <div className="space-x-2 bg-red-50 p-4 rounded flex items-center text-red-600 my-10 -mt-40 shadow-lg mx-auto max-w-2xl w-full">
    <div className="">
      <svg
    ...
    <h3 className="text-red-800 tracking-wider flex-1">{text}</h3>
    <button
